...
<style lang="scss" scoped>
	...
	.el-main {
		...
		margin: 0 0 0 220px;
		overflow: hidden;
		background: url(http://codegen.caihongy.cn/20230220/9defa2f73e75484caa13ae87e9063c88.jpg) no-repeat center bottom;
	}
	.main_view-collapse {
		padding: 0;
		margin: 0 0 0 64px;
	...
	.index-aside {
		...
		top: 64px;
		left: 0;
		background: url(http://codegen.caihongy.cn/20230217/299885ccff7a438eb2767ce47b3fac29.gif);
		width: 220px;
		border-color: #d9d9d9;

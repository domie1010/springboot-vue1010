		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					...
					<div  class="info_text" >{{detail.jubaoyuanyin}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">举报时间</div>
					<div  class="info_text" >{{detail.jubaoshijian}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">举报人账号</div>
					<div  class="info_text" >{{detail.jubaorenzhanghao}}</div>
				</div>
				...
				<div class="btn_view">
					<el-button class="approval_btn" v-if="btnAuth('jubaoxinxi','审核')" type="warning" @click="approvalClick()">审核</el-button>
					<el-button v-if="centerType&&(detail.ispay=='未支付'||!detail.ispay)&&btnFrontAuth('jubaoxinxi','支付')" class="approval_btn" @click="payClick">支付</el-button>
					<el-button class="edit_btn" v-if="centerType&&btnAuth('jubaoxinxi','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('jubaoxinxi','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>

	...
	<div class="app-contain" :style='{"minHeight":"100vh","padding":"0 10%","margin":"40px auto 60px","color":"#666","background":"#fff","width":"100%","fontSize":"14px","position":"relative","height":"100%"}'>
		...
		<el-form ref="formRef" :model="form" class="add_form" label-width="120px" :rules="rules">
			<el-row>
				...
				<el-col :span="24">
					<el-form-item label="反馈详情" prop="fankuixiangqing">
						<el-input v-model="form.fankuixiangqing" placeholder="反馈详情" type="textarea"
						:readonly="!isAdd||disabledForm.fankuixiangqing?true:false"
						/>
					</el-form-item>
				</el-col>
			</el-row>
	...
	const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='fankuixiangqing'){
					form.value.fankuixiangqing = row[x];
					disabledForm.value.fankuixiangqing = true;
					continue;
				}
				if(x=='fankuishijian'){
